...
const BuyNowButton = () => {
  ...
  return (
    ...
    //     href='https://themeselection.com/products/kati-mui-react-nextjs-admin-template/'
    //     sx={{
    ...
    //           href='https://themeselection.com/products/kati-mui-react-nextjs-admin-template/'
    //         >
    //           <img width='100%' alt='kati-pro-banner' src='/images/misc/kati-pro-banner.png' />
    //         </a>
    //         <CardContent>
    //           <Typography sx={{ mb: 4 }} variant='h6'>
    //             kati - React Admin Template
    //           </Typography>
    //           <Typography sx={{ mb: 4 }} variant='body2'>
    //             kati Admin is the most developer friendly & highly customizable Admin Dashboard Template based on MUI
    //             and NextJS.
    //           </Typography>
    //           <Typography sx={{ mb: 4 }} variant='body2'>
    ...
    //             target='_blank'
    //             variant='contained'
    //             href='https://demos.themeselection.com/kati-mui-react-nextjs-admin-template/landing/'
    //           >
    //             Demo
    //           </Button>
    //           <Button
